...
def main():
    ...
    result_frame.grid(row=1,column=0,columnspan=4, padx=20, pady=10)
    

    # Create a label to display the result text

    result_label = tk.Label(result_frame, text="IFC", font=("Helvetica", 14), wraplength=1000, name='frame1')
    #result_label.pack()
    result_label.grid()
    ...
    button3 = tk.Button(shared_module.root, text="Ativar Pop-up", command=label_code_3)
    #button2.pack(side=tk.LEFT, padx=10, pady=10)
